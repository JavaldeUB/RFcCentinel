...
for n_comp in xticks:
    y_cv, r2, mse, rpd = optimise_pls_cv(X_train, y_train, n_comp)  # Perform optimisation on training data
    r2s.append(r2)
    mses.append(mse)
    rpds.append(rpd)
...
print(f"Test Set Results - R2: {r2_test:.4f}, MSE: {mse_test:.4f}, RPD: {rpd_test:.4f}")
