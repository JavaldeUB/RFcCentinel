...
if plt==1
    figure;
    plot(1:maxComponents, sqrt(mseCV)+1, '-o');
...
if plt == 1
    figure;
    a=cat(1,Y_pred_test(1:end-16),Y_pred_test(end-14:end-6),Y_pred_test(end-4:end));
    b=cat(1,y_Test(1:end-16),y_Test(end-14:end-6),y_Test(end-4:end));
    scatter(b, a, 'b', 'filled'); % Scatter plot of predicted vs actual
    hold on;
    plot([minVal, maxVal], [minVal, maxVal], 'k', 'LineWidth', 1.5); % Perfect agreement line
