...
baseFolder = 'C:\Users\javit\Documents\curso24_25\Investigacion\UB\GRAF\RFcCentinel\python\dataBase_WaterInVial_1p2mL_1p6to3GHz'; % Replace with your base folder path
...
for i = 1:length(dateFolders)
    ...
    for j = 1:length(sampleFolders)
        ...
        for k = 1:length(csvFiles)
            ...
            vialStr = regexp(csvFileName, 'x0_(\d+)', 'tokens', 'once');
